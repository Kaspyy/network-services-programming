...
int main(int argc, char **argv)
{
    ...
    /* sinit_num_ostreams - liczba strumieni do utworzenia na połączeniu */
    initmsg.sinit_num_ostreams = 10;
    /* sinit_max_instreams - maksymalna liczba strumieni, które można utworzyć na połączeniu */
    initmsg.sinit_max_instreams = 10;
    /* sinit_max_attempts - maksymalna liczba prób otwarcia połączenia */
    initmsg.sinit_max_attempts = 5;
    /* sinit_max_init_timeo - maksymalny czas oczekiwania na odpowiedź na INIT */
    ...
    for (;;)
    {
        ...
        /* sctp_recvmsg() zwróci -1, gdy nie uda się odebrać wiadomości */
        ...
        /* switch(user_arg) - zmienia stream_number, który jest wysyłany */
        switch (user_arg)
        {
            /* 0 - nie zwiększaj stream_number */
        case 0:
