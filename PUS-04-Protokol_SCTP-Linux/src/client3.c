...
int main(int argc, char **argv)
{
    ...
    /* sinit_max_attempts - maksymalna liczba prób utworzenia połączenia */
    initmsg.sinit_max_attempts = 5;
    /* sinit_max_init_timeo - maksymalny czas oczekiwania na połączenie */
